...
namespace Excel.Csv
{
    internal class CsvWriter : IExcelWriter , IExcelWriterAsync
    {
        ...
        private void GenerateSheetByProperties(StreamWriter writer, IEnumerable value, List<Helpers.ExcelCustomPropertyInfo> props, string seperator, string newLine)
        {
    ...
    {
        public static string ToCsvString(this object value, Helpers.ExcelCustomPropertyInfo p)
        {
            if (value == null)
                return "";
