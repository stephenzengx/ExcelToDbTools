...
namespace Excel.OpenXml
{
    ...
    internal class ExcelOpenXmlSheetWriter : IExcelWriter , IExcelWriterAsync
    {
        ...
        private void GenerateSheetByProperties(StreamWriter writer, MiniExcelZipArchive archive, IEnumerable value, List<Helpers.ExcelCustomPropertyInfo> props, int rowCount, int xIndex = 1, int yIndex = 1)
        {
        ...
        private static void WriteCell(StreamWriter writer, int yIndex, int cellIndex, object value, Helpers.ExcelCustomPropertyInfo p)
        {
            var v = string.Empty;
            var t = "str";
            var s = "2";
