namespace Excel.Utils
{
    ...
    internal static partial class TypeHelper
    {
        ...
        public static object TypeMapping<T>(T v, Helpers.ExcelCustomPropertyInfo pInfo, object newValue, object itemValue, int rowIndex, string startCell) where T : class, new()
        {
            try
            {
        ...
        private static object TypeMappingImpl<T>(T v, Helpers.ExcelCustomPropertyInfo pInfo, ref object newValue, object itemValue) where T : class, new()
        {
