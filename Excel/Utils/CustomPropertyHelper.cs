...
namespace Excel.Utils
{
    ...
    internal static partial class CustomPropertyHelper
    {
        ...
        internal static List<Helpers.ExcelCustomPropertyInfo> GetSaveAsProperties(this Type type)
        {
            List<Helpers.ExcelCustomPropertyInfo> props = GetExcelPropertyInfo(type, BindingFlags.Public | BindingFlags.Instance)
            ...
            //TODO: need optimize performance
            {
                ...
                List<Helpers.ExcelCustomPropertyInfo> newProps = new List<Helpers.ExcelCustomPropertyInfo>();
                var index = 0;
        ...
        internal static List<Helpers.ExcelCustomPropertyInfo> GetExcelCustomPropertyInfos(Type type, string[] headers)
        {
            List<Helpers.ExcelCustomPropertyInfo> props = GetExcelPropertyInfo(type, BindingFlags.SetProperty | BindingFlags.Public | BindingFlags.Instance)
        ...
        private static IEnumerable<Helpers.ExcelCustomPropertyInfo> GetExcelPropertyInfo(Type type, BindingFlags bindingFlags)
        {
            return type.GetProperties(bindingFlags)
                 ...
                 .Select(p =>
                 {
                     ...
                     return new Helpers.ExcelCustomPropertyInfo
                     {
                         Property = p,
